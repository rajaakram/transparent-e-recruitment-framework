// from openzeppelin test suite 
// https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/test/token/ERC721/extensions/ERC721Burnable.test.js
...
async function fixture() {
  ...
  const token = await ethers.deployContract('Issuance');
...
describe('ERC721Burnable', function () {
  ...
  describe('like a burnable ERC721', function () {
    beforeEach(async function () {
      await this.token.create(this.owner, "");
      await this.token.create(this.owner, "");
    });
